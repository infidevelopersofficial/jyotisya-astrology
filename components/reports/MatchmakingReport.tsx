    ...
    <PdfContainer id="matchmaking-report-root">
      <PdfPage pageNumber={1} title="Compatibility Report">
         ...
         <div className="text-center mb-10">
            <h1 className="text-3xl font-bold text-slate-800 uppercase tracking-widest mb-4">
               Kundli Milan Report
            </h1>
         ...
         <div className="grid grid-cols-2 gap-8 mb-10">
            ...
            <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
               ...
               <div className="space-y-2 text-sm text-slate-700">
                  <div className="grid grid-cols-[80px_1fr]">
                     ...
                     <span className="font-medium">{new Date(boy.dateTime).toLocaleString()}</span>
                  </div>
                  <div className="grid grid-cols-[80px_1fr]">
            ...
            <div className="bg-pink-50 p-6 rounded-xl border border-pink-100">
               ...
               <div className="space-y-2 text-sm text-slate-700">
                  <div className="grid grid-cols-[80px_1fr]">
                     <span className="text-slate-500">Birth:</span>
                     <span className="font-medium">{new Date(girl.dateTime).toLocaleString()}</span>
                  </div>
                  <div className="grid grid-cols-[80px_1fr]">
                     <span className="text-slate-500">Location:</span>
          ...
          <div className="bg-white">
             ...
             <table className="w-full text-sm rounded-lg overflow-hidden border border-slate-200">
                <thead className="bg-slate-100 text-slate-700">
                   <tr>
                      <th className="p-4 text-left font-bold">Attribute (Kuta)</th>
                      <th className="p-4 text-left font-bold">Description</th>
                      <th className="p-4 text-right font-bold">Obtained</th>
