...
```bash
git push origin refactor/simplified-nextjs-saas
```
...
4. Choose the `refactor/simplified-nextjs-saas` branch
...
Every push to `refactor/simplified-nextjs-saas` will automatically deploy to Vercel.
...
- Or set production branch to `refactor/simplified-nextjs-saas`
